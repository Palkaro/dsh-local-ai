...
- **केवल rc.6** — `@deepseek-ai/dsh@0.1.0-rc.6` के विरुद्ध विकसित व परीक्षित; नए harness बेसलाइन काम करने की अपेक्षा है, पर मासिक compat workflow उन्हें सत्यापित करता है।
...
pnpm run typecheck  # tsc: src + परीक्षण, प्रकाशित 0.1.0-rc.6 प्रकारों के विरुद्ध
pnpm run typecheck:ci  # सख्त tsc, प्रकाशित rc.6 प्रकारों के विरुद्ध (skipLibCheck बंद)
