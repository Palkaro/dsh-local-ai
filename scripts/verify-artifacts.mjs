...
// bundle, import it under plain Node, and assert the shipped files the export
// path needs. Guards against TypeScript-only syntax leaking into shipped
// output and against a tarball missing the bundle patch.
...
if (typeof index.apply !== 'function' || index.name !== 'local-ai') {
